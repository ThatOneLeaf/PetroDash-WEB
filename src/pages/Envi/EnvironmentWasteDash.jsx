            ...
            <>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <IconButton
                    onClick={() => openZoomModal(
                      `Total Hazard Waste ${activeTab === 'hazardous_generated' ? 'Generated' : 'Disposed'} by Waste Type (${unit})`,
                          ...
                          >
                            ...
                            >
                              {currentData.barChartData.map((entry, index) => (
                                <Cell
                                  key={`bar-cell-${index}`}
                                  fill={barChartColors[entry.waste_type] || wasteTypeColors[entry.waste_type] || COLORS[index % COLORS.length]}
                                />
                              ))}
                            </Bar>
                          </BarChart>
