        ...
        <Paper sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ 
              ...
              Are you sure you want to add this non-hazard waste generation record?
            </Typography>
            ...
            <Box sx={{ 
              ...
              <Typography sx={{ fontSize: '0.9rem', mb: 1 }}>
                <strong>Period:</strong> {formData.month} {formData.quarter} {formData.year}
              </Typography>
              <Typography sx={{ fontSize: '0.9rem', mb: 1 }}>
                <strong>Waste Generated:</strong> {formData.waste} {formData.unit_of_measurement}
              </Typography>
            </Box>
          </Box>
        ...
        <Paper sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ 
              ...
              Your non-hazard waste generation record has been successfully added to the repository.
            </Typography>
          </Box>
