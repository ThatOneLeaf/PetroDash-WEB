          ...
          mb: 3
           ...
           <TextField
            ...
            onChange={(event) => {
              ...
              if (value === '') {
                setFormData(prev => ({ ...prev, waste_disposed: '' }));
                return;
              }
              ...
              if (isValidInput) {
                ...
                if (value.includes('.') && (value.endsWith('.') || numValue > 0)) {
                  setFormData(prev => ({ ...prev, waste_disposed: value }));
        ...
        <Paper sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ 
              ...
              Are you sure you want to add this hazard waste disposal record?
            </Typography>
            ...
            <Box sx={{ 
              ...
              <Typography sx={{ fontSize: '0.9rem', mb: 1 }}>
                <strong>Waste Disposed:</strong> {formData.waste_disposed} {formData.unit_of_measurement}
              </Typography>
            </Box>
          </Box>
        ...
        <Paper sx={{
          ...
          <Box sx={{
            ...
            <Typography sx={{ 
              ...
              Your hazard waste disposal record has been successfully added to the repository.
            </Typography>
          </Box>
